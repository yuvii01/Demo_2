...
const Result = styled.div`
  ...
  max-height: 900px;   // Increased from 400px
  overflow-y: auto;

  @media (max-width: 600px) {
    font-size: 0.97rem;
    padding: 14px 8px;
    min-height: 120px;   // Increased from 40px
    max-height: 250px;   // Increased from 160px
  }
`;
...
`;
    ...
    const apiKey = import.meta.env.VITE_GEMINI_API3;
  ...
  return (
    <PageWrapper>
      <Card>
        <Title>Revision Planner <span  style={{
    float: 'right',
    cursor: 'pointer',
    fontSize: '1.3em',
    marginLeft: 'auto',
